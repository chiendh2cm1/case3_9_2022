        ...
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="product-content">
                    ...
                    <a style="width: 100px; !important; height: 50px; !important;" href="/cart?action=addProductToCart&productId=${detail.productId}" class="btn btn-outline-danger" id="addToCart">
