...
<section class="cart-total-page spad">
    <div class="container">
                    ...
                    <table class="table table-hover" style="margin-bottom: 20px">
                        ...
                        <c:forEach items="${order.orderdetails}" var="orderdetail">
                            <tr>
                                ...
                                <td>
                                    <a href="/cart?action=deleteProductInCart&productId=${orderdetail.product.productId}"><input
        ...
        <div class="checkout-form-row">
            <div class="col-lg-12">
                <h3 style="margin-bottom: 40px">Consignee Information</h3>
            </div>
            <div>
                <form action="/cart?action=checkInfoCustomer" method="post" class="deliveryInformation">
